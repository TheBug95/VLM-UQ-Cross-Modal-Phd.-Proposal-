...
| **Self-consistency (baseline 10×, T=1.5, voto 3-vías)** | Mejor señal SC = **frac_other 0.655** (deriva fuera del formato binario); entropía 3-vías 0.552; entropía binaria 0.573 (mismas 50 imágenes) | **Nuestro 1× (0.772 en el mismo subconjunto) supera al mejor 10× (0.655).** La información de SC no está en la duda sí/no (saturada) sino en la deriva a explicar. Nota: AUROCs del subconjunto (12 errores) no comparables con los de la cohorte |

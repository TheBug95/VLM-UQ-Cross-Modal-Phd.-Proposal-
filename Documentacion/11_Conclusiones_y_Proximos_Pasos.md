...
3. **Framework de evaluación con 97 variantes y baselines de igual costo**, todas extraídas en la misma pasada: un banco de pruebas reutilizable para UQ en VLMs (ablaciones completas en [07](07_Ablaciones_y_Analisis_Profundo.md)).
